...
void init_track_a(track_node *track) {
  ...
  track[142].segmentId = 2;

  track[143].name = "EX10";
  track[143].type = NODE_EXIT;
  track[143].reverse = &track[142];
  track[143].segmentId = 2;
}

void init_track_b(track_node *track) {
  memset(track, 0, TRACK_MAX*sizeof(track_node));
  track[0].name = "A1";
  track[0].type = NODE_SENSOR;
  track[0].num = 0;
  ...
  track[134].segmentId = 1;

  track[135].name = "EX7";
  track[135].type = NODE_EXIT;
  track[135].reverse = &track[134];
  track[135].segmentId = 1;
  ...
  track[136].segmentId = 3;

  track[137].name = "EX9";
  track[137].type = NODE_EXIT;
  track[137].reverse = &track[136];
  track[137].segmentId = 3;
  ...
  track[138].segmentId = 2;

  track[139].name = "EX10";
  track[139].type = NODE_EXIT;
  track[139].reverse = &track[138];
  track[139].segmentId = 2;
}
