...
static const int FOLLOWING_DIST_MM = 250;
static const int FOLLOWING_DIST_MARGIN_MM = 80;
static const int TREND_MARGIN_UM = 19000; // 17.5mm
static const int LARGE_TREND = 90; // mm
